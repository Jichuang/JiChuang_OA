...
CKEDITOR.lang['ku'] = {
    ...
    "blockquote": {"toolbar": "بەربەستکردنی وتەی وەرگیراو"},
    "clipboard": {
        "copy": "لەبەرگرنتەوه",
    ...
    "elementspath": {"eleLabel": "ڕێڕهوی توخمهکان", "eleTitle": "%1 توخم"},
    ...
    "maximize": {"maximize": "ئەوپهڕی گەورەیی", "minimize": "ئەوپەڕی بچووکی"},
    "pastetext": {"button": "لکاندنی وهك دهقی ڕوون", "title": "لکاندنی وهك دهقی ڕوون"},
    "pastefromword": {
    ...
    "undo": {"redo": "هەڵگەڕاندنەوه", "undo": "پووچکردنەوه"},
    "wsc": {
