!function (t) {
    ...
    var e = t.HTMLCanvasElement && t.HTMLCanvasElement.prototype, n = t.Blob && function () {
        ...
        var e, i, a, l, u, B;
        for (e = t.split(",")[0].indexOf("base64") >= 0 ? atob(t.split(",")[1]) : decodeURIComponent(t.split(",")[1]), i = new ArrayBuffer(e.length), a = new Uint8Array(i), l = 0; l < e.length; l += 1)a[l] = e.charCodeAt(l);
