...
!function (e) {
    ...
    function v(t) {
        if (!j) {
            ...
            j = e(document.createElement("div")).css({
                ...
                whiteSpace: "nowrap"
            }), j.attr("class", "select2-sizer"), e("body").append(j)
        }
    ...
    function w(i) {
        ...
        return function (l) {
            window.clearTimeout(n), n = window.setTimeout(function () {
                var n = i.data, r = o, d = i.transport || e.fn.select2.ajaxDefaults.transport, h = {
                    type: i.type || "GET",
                    cache: i.cache || !1,
                    jsonpCallback: i.jsonpCallback || t,
                    dataType: i.dataType || "json"
                }, c = e.extend({}, e.fn.select2.ajaxDefaults.params, h);
                n = n ? n.call(s, l.term, l.page, l.context) : null, r = "function" == typeof r ? r.call(s, l.term, l.page, l.context) : r, a && a.abort(), i.params && (e.isFunction(i.params) ? e.extend(c, i.params.call(s)) : e.extend(c, i.params)), e.extend(c, {
                    url: r, dataType: i.dataType, data: n, success: function (e) {
    ...
    if (window.Select2 === t) {
        var A, I, R, N, D, j, P, L, O = {x: 0, y: 0}, A = {
            TAB: 9,
            ENTER: 13,
            ESC: 27,
            SPACE: 32,
        ...
        }, H = "<div class='select2-measure-scrollbar'></div>", B = {
            "Ⓐ": "A",
            "Ａ": "A",
            "À": "A",
            "Á": "A",
        ...
        P = e(document), D = function () {
            ...
            bind: function (e) {
                ...
                if ((i === !0 || !g || !r(p, g)) && (e.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    c.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + c.formatSearching() + "</li>"), d.addClass("select2-active"), this.removeHighlight(), s = this.tokenize(), s != t && null != s && d.val(s), this.resultsPage = 1, c.query({
                        element: c.element,
                        term: d.val(),
            ...
            createContainer: function () {
                ...
                if (i) {
                    ...
                    this.opts.element.val(a ? a.val() : ""), this.selection.find(".select2-chosen").empty(), this.selection.removeData("select2-data"), this.setPlaceholder(), t !== !1 && (this.opts.element.trigger({
                ...
                if (this.triggerSelect(e)) {
                    ...
                    this.opts.element.val(this.id(e)), this.updateSelection(e), this.opts.element.trigger({
                        ...
                        val: this.id(e),
                        choice: e
                    }), this.nextSearchTerm = this.opts.nextSearchTerm(e, this.search.val()), this.close(), t && t.noFocus || this.focusser.focus(), r(i, this.id(e)) || this.triggerChange({
                        added: e,
                        removed: n
                    })
                }
                ...
                if (e = arguments[0], arguments.length > 1 && (i = arguments[1]), this.select)this.select.val(e).find(":selected").each2(function (e, t) {
                    ...
                    this.opts.element.val(e), this.opts.initSelection(this.opts.element, function (e) {
                        a.opts.element.val(e ? a.id(e) : ""), a.updateSelection(e), a.setPlaceholder(), i && a.triggerChange({
                            added: e,
                            removed: r
                        })
                    })
            ...
            createContainer: function () {
                ...
                if (t = e.data("select2-data")) {
                    ...
                    e.remove(), this.opts.element.trigger({
                        type: "removed",
                        val: this.id(t),
                        choice: t
                ...
                if (a = this.data(), a.length || (a = []), !i && 0 !== i)return this.opts.element.val(""), this.updateSelection([]), this.clearSearch(), n && this.triggerChange({
                    added: this.data(),
                    removed: a
                }), void 0;
            ...
            query: {ajax: w, local: C, tags: _},
            util: {debounce: h, markMatch: b, escapeMarkup: x, stripDiacritics: i},
            "class": {"abstract": I, single: R, multi: N}
        }
    }
}(jQuery);