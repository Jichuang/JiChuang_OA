 ...
 */
(function (f) {
    void 0 == f.fn.inputmask && (f.inputmask = {
        defaults: {
            placeholder: "_",
                    ...
                    if (e && !c) {
                        for (var f = e.prevalidator, j = f ? f.length : 0, l = 1; l < e.cardinality; l++) {
                            ...
                            s.push({
                                ...
                                cardinality: g ? g : 1,
                                optionality: b,
                                newBlockMarker: !0 == b ? d : !1,
                                offset: 0,
                                casing: e.casing,
                                def: e.definitionSymbol | a
                            });
                            !0 == b && (d = !1)
                        }
                        s.push({
                            fn: e.validator ? "string" == typeof e.validator ? RegExp(e.validator) :
                                new function () {
        ...
        function u() {
            function a(c, d) {
                ...
                1 < y.length ? (f = c + y[0] + (h.optionalmarker.start + y[1] + h.optionalmarker.end) + (1 < e.length ? e[1] : ""), m = j(f), b.push({
                    mask: f,
                    _buffer: m.mask,
                    tests: l(f),
                    ...
                    greedy: m.greedy,
                    repeat: m.repeat
                }), f = c + y[0] + (1 < e.length ? e[1] : ""), m = j(f), b.push({
                    mask: f,
                    _buffer: m.mask,
                    tests: l(f),
                    lastValidPosition: void 0,
                ...
                (a(c + y[0] + (h.optionalmarker.start + y[1] + h.optionalmarker.end), e[1]), a(c + y[0], e[1]))) : (f = c + e, m = j(f), b.push({
                    mask: f,
                    _buffer: m.mask,
                    tests: l(f),
                    lastValidPosition: void 0,
        ...
        function P(a) {
            ...
            function d(a) {
                ...
                if (b && b.get)a._valueGet || (a._valueGet = b.get, a._valueSet = b.set, Object.defineProperty(a, "value", {
                    get: function () {
...
(function (f) {
    ...
    f.extend(f.inputmask.defaults.aliases, {
        url: {
            ...
            mask: "i.i.i.i", definitions: {
                i: {
                    validator: "25[0-5]|2[0-4][0-9]|[01][0-9][0-9]", cardinality: 3, prevalidator: [
...
(function (f) {
    f.extend(f.inputmask.defaults.definitions, {
        h: {
            validator: "[01][0-9]|2[0-3]", cardinality: 2, prevalidator: [
                {validator: "[0-2]", cardinality: 1}
            ]
        }, s: {
            ...
            validator: "0[1-9]|[12][0-9]|3[01]", cardinality: 2, prevalidator: [
                {validator: "[0-3]", cardinality: 1}
            ]
        }, m: {
            validator: "0[1-9]|1[012]", cardinality: 2, prevalidator: [
    ...
    f.extend(f.inputmask.defaults.aliases, {
            ...
            definitions: {
                1: {
                    validator: function (a, d, c, e, b) {
                        ...
                        if (!e && !j && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))if (j = b.regex.val1.test("0" + a.charAt(0)))return d[c - 1] = "0", {
                            pos: c,
                            c: a.charAt(0)
                        };
                        return j
                    ...
                    validator: function (a, d, c, e, b) {
                        ...
                        a);
                        if (!e && !f && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))if (f = b.regex.val2(b.separator).test(j + "0" + a.charAt(0)))return d[c - 1] = "0", {
                            pos: c,
                            c: a.charAt(0)
                        };
                        return f
        ...
        "yyyy/mm/dd": {
            mask: "y/1/2", placeholder: "yyyy/mm/dd", alias: "mm/dd/yyyy", leapday: "/02/29",
            onKeyUp: function (a, d, c) {
                d = f(this);
                ...
                2: {
                    validator: function (a, d, c, e, b) {
                        ...
                        if (!e && !l && (a.charAt(1) == b.separator || -1 != "-./".indexOf(a.charAt(1))))if (l = b.regex.val2(b.separator).test(f + "0" + a.charAt(0)))return d[c - 1] = "0", {
                            pos: c,
                            c: a.charAt(0)
                        };
                        if (l) {
        ...
        datetime: {
            ...
            regex: {
                ...
                ampmpre: /[apAP]/,
                ampm: /^[a|p|A|P][m|M]/
            }, timeseparator: ":", hourFormat: "24", definitions: {
                h: {
                    validator: function (a, d, c, e, b) {
                        ...
                        return f && "24" !== b.hourFormat && b.regex.hrs24.test(a) ? (a = parseInt(a, 10), d[c + 5] = 24 == a ? "a" : "p", d[c + 6] = "m", a -= 12, 10 > a ? (d[c] = a.toString(),
                            d[c - 1] = "0") : (d[c] = a.toString().charAt(1), d[c - 1] = a.toString().charAt(0)), {
                            pos: c,
                            c: d[c]
                        }) : f
                    }, cardinality: 2, prevalidator: [
        ...
        datetime12: {mask: "1/2/y h:s t", placeholder: "dd/mm/yyyy hh:mm xm", alias: "datetime", hourFormat: "12"},
        "hh:mm t": {mask: "h:s t", placeholder: "hh:mm xm", alias: "datetime", hourFormat: "12"},
        "h:s t": {mask: "h:s t", placeholder: "hh:mm xm", alias: "datetime", hourFormat: "12"},
...
(function (f) {
    f.extend(f.inputmask.defaults.aliases, {
        decimal: {
            ...
            groupSize: 3,
            autoGroup: !1,
            getMaskLength: function (a, d, c, e, b) {
                var j = a.length;
