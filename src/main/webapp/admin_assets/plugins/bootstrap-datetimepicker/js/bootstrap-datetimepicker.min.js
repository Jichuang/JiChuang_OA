!function (t) {
    ...
    i.prototype = {constructor: i, _events: [], _attachEvents: function () {
        ...
        this.endDate = t || 1 / 0, 1 / 0 !== this.endDate && (this.endDate = o.parseDate(this.endDate, this.format, this.language, this.formatType)), this.update(), this.updateNavArrows()
        ...
        if (!this.isInline) {
            var e, i, n, o = parseInt(this.element.parents().filter(function () {
                return"auto" != t(this).css("z-index")
            }).first().css("z-index")) + 10;
            this.component ? (e = this.component.offset(), n = e.left, ("bottom-left" == this.pickerPosition || "top-left" == this.pickerPosition) && (n += this.component.outerWidth() - this.picker.outerWidth())) : (e = this.element.offset(), n = e.left), i = "top-left" == this.pickerPosition || "top-right" == this.pickerPosition ? e.top - this.picker.outerHeight() : e.top + this.height, this.picker.css({top: i, left: n, zIndex: o})
        }
    }, update: function () {
        var t, e = !1;
        ...
        if (null != this.date && null != this.viewDate) {
            var i = new Date(this.viewDate), a = i.getUTCFullYear(), r = i.getUTCMonth(), s = i.getUTCDate(), c = i.getUTCHours(), l = i.getUTCMinutes(), h = this.startDate !== -1 / 0 ? this.startDate.getUTCFullYear() : -1 / 0, u = this.startDate !== -1 / 0 ? this.startDate.getUTCMonth() : -1 / 0, d = 1 / 0 !== this.endDate ? this.endDate.getUTCFullYear() : 1 / 0, f = 1 / 0 !== this.endDate ? this.endDate.getUTCMonth() : 1 / 0, g = new e(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate()).valueOf(), p = new Date;
            if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(n[this.language].months[r] + " " + a), "time" == this.formatViewType) {
                var _ = c % 12 ? c % 12 : 12, b = (10 > _ ? "0" : "") + _, m = (10 > l ? "0" : "") + l, v = n[this.language].meridiem[12 > c ? 0 : 1];
                this.picker.find(".datetimepicker-hours thead th:eq(1)").text(b + ":" + m + " " + v.toUpperCase()), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(b + ":" + m + " " + v.toUpperCase())
            } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(s + " " + n[this.language].months[r] + " " + a), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(s + " " + n[this.language].months[r] + " " + a);
            this.picker.find("tfoot th.today").text(n[this.language].today).toggle(this.todayBtn !== !1), this.updateNavArrows(), this.fillMonths();
            var w = e(a, r - 1, 28, 0, 0, 0, 0), y = o.getDaysInMonth(w.getUTCFullYear(), w.getUTCMonth());
            w.setUTCDate(y), w.setUTCDate(y - (w.getUTCDay() - this.weekStart + 7) % 7);
            var x = new Date(w);
            x.setUTCDate(x.getUTCDate() + 42), x = x.valueOf();
            for (var k, C = []; w.valueOf() < x;)w.getUTCDay() == this.weekStart && C.push("<tr>"), k = "", w.getUTCFullYear() < a || w.getUTCFullYear() == a && w.getUTCMonth() < r ? k += " old" : (w.getUTCFullYear() > a || w.getUTCFullYear() == a && w.getUTCMonth() > r) && (k += " new"), this.todayHighlight && w.getUTCFullYear() == p.getFullYear() && w.getUTCMonth() == p.getMonth() && w.getUTCDate() == p.getDate() && (k += " today"), w.valueOf() == g && (k += " active"), (w.valueOf() + 864e5 <= this.startDate || w.valueOf() > this.endDate || -1 !== t.inArray(w.getUTCDay(), this.daysOfWeekDisabled)) && (k += " disabled"), C.push('<td class="day' + k + '">' + w.getUTCDate() + "</td>"), w.getUTCDay() == this.weekEnd && C.push("</tr>"), w.setUTCDate(w.getUTCDate() + 1);
            this.picker.find(".datetimepicker-days tbody").empty().append(C.join("")), C = [];
            for (var A = "", T = "", D = "", B = 0; 24 > B; B++) {
                var E = e(a, r, s, B);
                k = "", E.valueOf() + 36e5 <= this.startDate || E.valueOf() > this.endDate ? k += " disabled" : c == B && (k += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (T = 12 > B ? n[this.language].meridiem[0] : n[this.language].meridiem[1], T != D && ("" != D && C.push("</fieldset>"), C.push('<fieldset class="hour"><legend>' + T.toUpperCase() + "</legend>")), D = T, A = B % 12 ? B % 12 : 12, C.push('<span class="hour' + k + " hour_" + (12 > B ? "am" : "pm") + '">' + A + "</span>"), 23 == B && C.push("</fieldset>")) : (A = B + ":00", C.push('<span class="hour' + k + '">' + A + "</span>"))
            }
            this.picker.find(".datetimepicker-hours td").html(C.join("")), C = [], A = "", T = "", D = "";
            for (var B = 0; 60 > B; B += this.minuteStep) {
                var E = e(a, r, s, c, B, 0);
                k = "", E.valueOf() < this.startDate || E.valueOf() > this.endDate ? k += " disabled" : Math.floor(l / this.minuteStep) == Math.floor(B / this.minuteStep) && (k += " active"), this.showMeridian && 2 == n[this.language].meridiem.length ? (T = 12 > c ? n[this.language].meridiem[0] : n[this.language].meridiem[1], T != D && ("" != D && C.push("</fieldset>"), C.push('<fieldset class="minute"><legend>' + T.toUpperCase() + "</legend>")), D = T, A = c % 12 ? c % 12 : 12, C.push('<span class="minute' + k + '">' + A + ":" + (10 > B ? "0" + B : B) + "</span>"), 59 == B && C.push("</fieldset>")) : (A = B + ":00", C.push('<span class="minute' + k + '">' + c + ":" + (10 > B ? "0" + B : B) + "</span>"))
            }
            this.picker.find(".datetimepicker-minutes td").html(C.join(""));
            var S = this.date.getUTCFullYear(), j = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(a).end().find("span").removeClass("active");
            S == a && j.eq(this.date.getUTCMonth()).addClass("active"), (h > a || a > d) && j.addClass("disabled"), a == h && j.slice(0, u).addClass("disabled"), a == d && j.slice(f + 1).addClass("disabled"), C = "", a = 10 * parseInt(a / 10, 10);
            var F = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
            a -= 1;
            for (var B = -1; 11 > B; B++)C += '<span class="year' + (-1 == B || 10 == B ? " old" : "") + (S == a ? " active" : "") + (h > a || a > d ? " disabled" : "") + '">' + a + "</span>", a += 1;
            F.html(C), this.place()
        }
    }, updateNavArrows: function () {
        var t = new Date(this.viewDate), e = t.getUTCFullYear(), i = t.getUTCMonth(), n = t.getUTCDate(), o = t.getUTCHours();
        switch (this.viewMode) {
            case 0:
                this.startDate !== -1 / 0 && e <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && n <= this.startDate.getUTCDate() && o <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({visibility: "hidden"}) : this.picker.find(".prev").css({visibility: "visible"}), 1 / 0 !== this.endDate && e >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && n >= this.endDate.getUTCDate() && o >= this.endDate.getUTCHours() ? this.picker.find(".next").css({visibility: "hidden"}) : this.picker.find(".next").css({visibility: "visible"});
                break;
            case 1:
        ...
        if (e.preventDefault(), e.stopPropagation(), !this.wheelPause) {
            this.wheelPause = !0;
            var i = e.originalEvent, n = i.wheelDelta, o = n > 0 ? 1 : 0 === n ? 0 : -1;
            ...
            switch (n[0].nodeName.toLowerCase()) {
                case"th":
                    switch (n[0].className) {
                        ...
                        case"prev":
                        case"next":
                            var a = o.modes[this.viewMode].navStep * ("prev" == n[0].className ? -1 : 1);
                            switch (this.viewMode) {
                                case 0:
                        ...
                        case"today":
                            var r = new Date;
                            r = e(r.getFullYear(), r.getMonth(), r.getDate(), r.getHours(), r.getMinutes(), r.getSeconds(), 0), this.viewMode = this.startViewMode, this.showMode(0), this._setDate(r), this.fill(), this.autoclose && this.hide()
                    }
                    break;
                case"span":
                    if (!n.is(".disabled")) {
                        var s = this.viewDate.getUTCFullYear(), c = this.viewDate.getUTCMonth(), l = this.viewDate.getUTCDate(), h = this.viewDate.getUTCHours(), u = this.viewDate.getUTCMinutes(), d = this.viewDate.getUTCSeconds();
                        if (n.is(".month") ? (this.viewDate.setUTCDate(1), c = n.parent().find("span").index(n), l = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(c), this.element.trigger({type: "changeMonth", date: this.viewDate}), this.viewSelect >= 3 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".year") ? (this.viewDate.setUTCDate(1), s = parseInt(n.text(), 10) || 0, this.viewDate.setUTCFullYear(s), this.element.trigger({type: "changeYear", date: this.viewDate}), this.viewSelect >= 4 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".hour") ? (h = parseInt(n.text(), 10) || 0, (n.hasClass("hour_am") || n.hasClass("hour_pm")) && (12 == h && n.hasClass("hour_am") ? h = 0 : 12 != h && n.hasClass("hour_pm") && (h += 12)), this.viewDate.setUTCHours(h), this.element.trigger({type: "changeHour", date: this.viewDate}), this.viewSelect >= 1 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".minute") && (u = parseInt(n.text().substr(n.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(u), this.element.trigger({type: "changeMinute", date: this.viewDate}), this.viewSelect >= 0 && this._setDate(e(s, c, l, h, u, d, 0))), 0 != this.viewMode) {
                            var f = this.viewMode;
                ...
                case"td":
                    if (n.is(".day") && !n.is(".disabled")) {
                        var l = parseInt(n.text(), 10) || 1, s = this.viewDate.getUTCFullYear(), c = this.viewDate.getUTCMonth(), h = this.viewDate.getUTCHours(), u = this.viewDate.getUTCMinutes(), d = this.viewDate.getUTCSeconds();
                        n.is(".old") ? 0 === c ? (c = 11, s -= 1) : c -= 1 : n.is(".new") && (11 == c ? (c = 0, s += 1) : c += 1), this.viewDate.setUTCFullYear(s), this.viewDate.setUTCMonth(c), this.viewDate.setUTCDate(l), this.element.trigger({type: "changeDay", date: this.viewDate}), this.viewSelect >= 2 && this._setDate(e(s, c, l, h, u, d, 0))
                    }
                    var f = this.viewMode;
                    this.showMode(-1), this.fill(), f == this.viewMode && this.autoclose && this.hide()
            }
        ...
        if (!e)return t;
        var i, n, o = new Date(t.valueOf()), a = o.getUTCDate(), r = o.getUTCMonth(), s = Math.abs(e);
        if (e = e > 0 ? 1 : -1, 1 == s)n = -1 == e ? function () {
            return o.getUTCMonth() == r
        } : function () {
            return o.getUTCMonth() != i
        }, i = r + e, o.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12); else {
            for (var c = 0; s > c; c++)o = this.moveMonth(o, e);
        ...
        if (o) {
            var r;
            this.isInput ? r = this.element : this.component && (r = this.element.find("input")), r && r.change(), this.element.trigger({type: "changeDate", date: this.date})
        }
    }, showMode: function (t) {
        if (t) {
    ...
    var n = t.fn.datetimepicker.dates = {en: {days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], meridiem: ["am", "pm"], suffix: ["st", "nd", "rd", "th"], today: "Today"}}, o = {modes: [
    ...
    }, parseDate: function (o, a, r, s) {
        if (o instanceof Date) {
            var c = new Date(o.valueOf() - 6e4 * o.getTimezoneOffset());
            return c.setMilliseconds(0), c
        }
        if (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(o) && (a = this.parseFormat("yyyy-mm-dd", s)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(o) && (a = this.parseFormat("yyyy-mm-dd hh:ii", s)), /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(o) && (a = this.parseFormat("yyyy-mm-dd hh:ii:ss", s)), /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(o)) {
            var l, h, u = /([-+]\d+)([dmwy])/, d = o.match(/([-+]\d+)([dmwy])/g);
            o = new Date;
            for (var f = 0; f < d.length; f++)switch (l = u.exec(d[f]), h = parseInt(l[1]), l[2]) {
                case"d":
                    o.setUTCDate(o.getUTCDate() + h);
                    break;
                case"m":
                    o = i.prototype.moveMonth.call(i.prototype, o, h);
                    break;
                case"w":
                    o.setUTCDate(o.getUTCDate() + 7 * h);
                    break;
                case"y":
                    o = i.prototype.moveYear.call(i.prototype, o, h)
            }
            return e(o.getUTCFullYear(), o.getUTCMonth(), o.getUTCDate(), o.getUTCHours(), o.getUTCMinutes(), o.getUTCSeconds(), 0)
        }
        var g, p, l, d = o && o.match(this.nonpunctuation) || [], o = new Date(0, 0, 0, 0, 0, 0, 0), _ = {}, b = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P"], m = {hh: function (t, e) {
        ...
        if (m.M = m.MM = m.mm = m.m, m.dd = m.d, m.P = m.p, o = e(o.getFullYear(), o.getMonth(), o.getDate(), o.getHours(), o.getMinutes(), o.getSeconds()), d.length == a.parts.length) {
            for (var f = 0, v = a.parts.length; v > f; f++) {
                if (g = parseInt(d[f], 10), l = a.parts[f], isNaN(g))switch (l) {
                    case"MM":
                        p = t(n[r].months).filter(function () {
                            var t = this.slice(0, d[f].length), e = d[f].slice(0, t.length);
                            return t == e
                        }), g = t.inArray(p[0], n[r].months) + 1;
                        break;
                    case"M":
                        p = t(n[r].monthsShort).filter(function () {
                            var t = this.slice(0, d[f].length), e = d[f].slice(0, t.length);
                            return t == e
                        }), g = t.inArray(p[0], n[r].monthsShort) + 1;
                        break;
                    case"p":
                    case"P":
                        g = t.inArray(d[f].toLowerCase(), n[r].meridiem)
                }
                _[l] = g
            }
            for (var w, f = 0; f < b.length; f++)w = b[f], w in _ && !isNaN(_[w]) && m[w](o, _[w])
        }
        return o
    }, formatDate: function (e, i, a, r) {
        if (null == e)return"";
        var s;
        if ("standard" == r)s = {yy: e.getUTCFullYear().toString().substring(2), yyyy: e.getUTCFullYear(), m: e.getUTCMonth() + 1, M: n[a].monthsShort[e.getUTCMonth()], MM: n[a].months[e.getUTCMonth()], d: e.getUTCDate(), D: n[a].daysShort[e.getUTCDay()], DD: n[a].days[e.getUTCDay()], p: 2 == n[a].meridiem.length ? n[a].meridiem[e.getUTCHours() < 12 ? 0 : 1] : "", h: e.getUTCHours(), i: e.getUTCMinutes(), s: e.getUTCSeconds()}, s.H = 0 == s.h % 12 ? 12 : s.h % 12, s.HH = (s.H < 10 ? "0" : "") + s.H, s.P = s.p.toUpperCase(), s.hh = (s.h < 10 ? "0" : "") + s.h, s.ii = (s.i < 10 ? "0" : "") + s.i, s.ss = (s.s < 10 ? "0" : "") + s.s, s.dd = (s.d < 10 ? "0" : "") + s.d, s.mm = (s.m < 10 ? "0" : "") + s.m; else {
            if ("php" != r)throw new Error("Invalid format type.");
            s = {y: e.getUTCFullYear().toString().substring(2), Y: e.getUTCFullYear(), F: n[a].months[e.getUTCMonth()], M: n[a].monthsShort[e.getUTCMonth()], n: e.getUTCMonth() + 1, t: o.getDaysInMonth(e.getUTCFullYear(), e.getUTCMonth()), j: e.getUTCDate(), l: n[a].days[e.getUTCDay()], D: n[a].daysShort[e.getUTCDay()], w: e.getUTCDay(), N: 0 == e.getUTCDay() ? 7 : e.getUTCDay(), S: e.getUTCDate() % 10 <= n[a].suffix.length ? n[a].suffix[e.getUTCDate() % 10 - 1] : "", a: 2 == n[a].meridiem.length ? n[a].meridiem[e.getUTCHours() < 12 ? 0 : 1] : "", g: 0 == e.getUTCHours() % 12 ? 12 : e.getUTCHours() % 12, G: e.getUTCHours(), i: e.getUTCMinutes(), s: e.getUTCSeconds()}, s.m = (s.n < 10 ? "0" : "") + s.n, s.d = (s.j < 10 ? "0" : "") + s.j, s.A = s.a.toString().toUpperCase(), s.h = (s.g < 10 ? "0" : "") + s.g, s.H = (s.G < 10 ? "0" : "") + s.G, s.i = (s.i < 10 ? "0" : "") + s.i, s.s = (s.s < 10 ? "0" : "") + s.s
        }
        for (var e = [], c = t.extend([], i.separators), l = 0, h = i.parts.length; h > l; l++)c.length && e.push(c.shift()), e.push(s[i.parts[l]]);
        return e.join("")
        ...
        return t
    }, headTemplate: '<thead><tr><th class="prev"><i class="icon-angle-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="icon-angle-right"/></th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr></tfoot>'};
