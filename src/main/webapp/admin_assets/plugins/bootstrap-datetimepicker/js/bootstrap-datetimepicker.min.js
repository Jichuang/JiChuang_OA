!function (t) {
                ...
                switch (n[0].nodeName.toLowerCase()) {
                    ...
                    case"span":
                        if (!n.is(".disabled")) {
                            ...
                            if (n.is(".month") ? (this.viewDate.setUTCDate(1), c = n.parent().find("span").index(n), l = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(c), this.element.trigger({
                                    type: "changeMonth",
                                    date: this.viewDate
                                }), this.viewSelect >= 3 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".year") ? (this.viewDate.setUTCDate(1), s = parseInt(n.text(), 10) || 0, this.viewDate.setUTCFullYear(s), this.element.trigger({
                                    type: "changeYear",
                                    date: this.viewDate
                                }), this.viewSelect >= 4 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".hour") ? (h = parseInt(n.text(), 10) || 0, (n.hasClass("hour_am") || n.hasClass("hour_pm")) && (12 == h && n.hasClass("hour_am") ? h = 0 : 12 != h && n.hasClass("hour_pm") && (h += 12)), this.viewDate.setUTCHours(h), this.element.trigger({
                                    type: "changeHour",
                                    date: this.viewDate
                                }), this.viewSelect >= 1 && this._setDate(e(s, c, l, h, u, d, 0))) : n.is(".minute") && (u = parseInt(n.text().substr(n.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(u), this.element.trigger({
                                    type: "changeMinute",
                                    date: this.viewDate
                                }), this.viewSelect >= 0 && this._setDate(e(s, c, l, h, u, d, 0))), 0 != this.viewMode) {
                                var f = this.viewMode;
                    ...
                    case"td":
                        if (n.is(".day") && !n.is(".disabled")) {
                            ...
                            n.is(".old") ? 0 === c ? (c = 11, s -= 1) : c -= 1 : n.is(".new") && (11 == c ? (c = 0, s += 1) : c += 1), this.viewDate.setUTCFullYear(s), this.viewDate.setUTCMonth(c), this.viewDate.setUTCDate(l), this.element.trigger({
                                type: "changeDay",
                                date: this.viewDate
                            }), this.viewSelect >= 2 && this._setDate(e(s, c, l, h, u, d, 0))
                        }
                        var f = this.viewMode;
                        this.showMode(-1), this.fill(), f == this.viewMode && this.autoclose && this.hide()
                }
    ...
    var n = t.fn.datetimepicker.dates = {
        ...
        parseDate: function (o, a, r, s) {
            ...
            var g, p, l, d = o && o.match(this.nonpunctuation) || [], o = new Date(0, 0, 0, 0, 0, 0, 0), _ = {}, b = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P"], m = {
                hh: function (t, e) {
        ...
        formatDate: function (e, i, a, r) {
            ...
            if ("standard" == r)s = {
                ...
                i: e.getUTCMinutes(),
                s: e.getUTCSeconds()
            }, s.H = 0 == s.h % 12 ? 12 : s.h % 12, s.HH = (s.H < 10 ? "0" : "") + s.H, s.P = s.p.toUpperCase(), s.hh = (s.h < 10 ? "0" : "") + s.h, s.ii = (s.i < 10 ? "0" : "") + s.i, s.ss = (s.s < 10 ? "0" : "") + s.s, s.dd = (s.d < 10 ? "0" : "") + s.d, s.mm = (s.m < 10 ? "0" : "") + s.m; else {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="icon-angle-left"/></th><th colspan="5" class="switch"></th><th class="next"><i class="icon-angle-right"/></th></tr></thead>',
