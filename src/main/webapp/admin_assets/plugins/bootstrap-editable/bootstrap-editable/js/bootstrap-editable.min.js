...
!function (t) {
    ...
    e.prototype = {
        constructor: e, initInput: function () {
            ...
            this.isSaving = !0, t.when(this.save(a)).done(t.proxy(function (t) {
                ...
                return e === !1 ? (this.error(!1), this.showForm(!1), void 0) : "string" == typeof e ? (this.error(e), this.showForm(), void 0) : (e && "object" == typeof e && e.hasOwnProperty("newValue") && (n = e.newValue), this.error(!1), this.value = n, this.$div.triggerHandler("save", {
                    newValue: n,
                    submitValue: a,
                    response: t
                }), void 0)
    ...
    e.prototype = {
        ...
        switch (i) {
            ...
            case"submit":
                ...
                return t.isEmptyObject(h) ? (o = this.editable("getValue"), s.data && t.extend(o, s.data), t.ajax(t.extend({
                    url: s.url,
                    data: o,
                    type: "POST"
                }, s.ajaxOptions)).success(function (t) {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {
        render: function () {
            ...
            if (t.isArray(e)) {
                ...
                for (var s = 0; s < e.length; s++)a = e[s], "object" == typeof a ? (i = 0, t.each(a, r), 1 === i ? o.push(n) : i > 1 && (a.children && (a.children = this.makeArray(a.children)), o.push(a))) : o.push({
                    value: a,
                    text: a
                })
        ...
        constructor: e, init: function () {
            ...
            function i(e, i) {
                ...
                return e.children("option").each(function (e, a) {
                    ...
                    "" !== o && (r = Math.abs(o - i), ("undefined" == typeof n.distance || r < n.distance) && (n = {
                        value: o,
                        distance: r
                    }))
                }), n.value
    ...
    "use strict";
    t.fn.popover.defaults = t.fn.popover.Constructor.DEFAULTS, t.extend(t.fn.editableContainer.Popup.prototype, {
        containerName: "popover",
        containerDataName: "bs.popover",
        innerCss: t.fn.popover && t(t.fn.popover.defaults.template).find("p").length ? ".popover-content p" : ".popover-content",
        initContainer: function () {
        ...
        setPosition: function () {
            !function () {
                ...
                switch (r = "function" == typeof this.options.placement ? this.options.placement.call(this, d[0], this.$element[0]) : this.options.placement, e = /in/.test(r), d.removeClass("top right bottom left").css({
                    top: 0,
                    left: 0,
                    display: "block"
                }), i = this.getPosition(e), n = d[0].offsetWidth, a = d[0].offsetHeight, r = e ? r.split(" ")[1] : r, l = {
                    top: i.top + i.height,
                    left: i.left + i.width / 2 - n / 2
                }, s = {top: i.top - a, left: i.left + i.width / 2 - n / 2}, h = {
                    top: i.top + i.height / 2 - a / 2,
                    left: i.left - n
                }, c = {top: i.top + i.height / 2 - a / 2, left: i.left + i.width}, r) {
                    case"bottom":
    ...
    var c = t.fn.datepicker.dates = {
        ...
        parseDate: function (i, n, r) {
            ...
            var p, f, o, h = i && i.match(this.nonpunctuation) || [], i = new Date, g = {}, m = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], v = {
                yyyy: function (t, e) {
        ...
        headTemplate: '<thead><tr><th class="prev"><i class="icon-angle-left"/></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="icon-angle-right"/></th></tr></thead>',
    ...
    "use strict";
    var e = function (i) {
        this.init("typeahead", i, e.defaults), this.options.typeahead = t.extend({}, e.defaults.typeahead, {
