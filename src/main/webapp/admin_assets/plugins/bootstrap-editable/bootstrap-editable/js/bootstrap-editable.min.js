...
!function (t) {
    ...
    e.prototype = {constructor: e, initInput: function () {
        ...
        var i, n = this.$form.find(".form-group"), a = this.$form.find(".editable-error-block");
        if (e === !1)n.removeClass(t.fn.editableform.errorGroupClass), a.removeClass(t.fn.editableform.errorBlockClass).empty().hide(); else {
            if (e) {
                i = e.split("\n");
                for (var r = 0; r < i.length; r++)i[r] = t("<div>").text(i[r]).html();
                e = i.join("<br>")
            }
        ...
        if (!this.options.savenochange && this.input.value2str(n) == this.input.value2str(this.value))return this.$div.triggerHandler("nochange"), void 0;
        var a = this.input.value2submit(n);
        this.isSaving = !0, t.when(this.save(a)).done(t.proxy(function (t) {
            ...
            return e === !1 ? (this.error(!1), this.showForm(!1), void 0) : "string" == typeof e ? (this.error(e), this.showForm(), void 0) : (e && "object" == typeof e && e.hasOwnProperty("newValue") && (n = e.newValue), this.error(!1), this.value = n, this.$div.triggerHandler("save", {newValue: n, submitValue: a, response: t}), void 0)
        ...
        var i, n = "function" == typeof this.options.pk ? this.options.pk.call(this.options.scope) : this.options.pk, a = !!("function" == typeof this.options.url || this.options.url && ("always" === this.options.send || "auto" === this.options.send && null !== n && void 0 !== n));
        return a ? (this.showLoading(), i = {name: this.options.name || "", value: e, pk: n}, "function" == typeof this.options.params ? i = this.options.params.call(this.options.scope, i) : (this.options.params = t.fn.editableutils.tryParseJson(this.options.params, !0), t.extend(i, this.options.params)), "function" == typeof this.options.url ? this.options.url.call(this.options.scope, i) : t.ajax(t.extend({url: this.options.url, data: i, type: "POST"}, this.options.ajaxOptions))) : void 0
    }, validate: function (t) {
        ...
        return this.each(function () {
            var a = t(this), r = a.data("editableform"), o = "object" == typeof i && i;
            r || a.data("editableform", r = new e(this, o)), "string" == typeof i && r[i].apply(r, Array.prototype.slice.call(n, 1))
        })
    ...
    "use strict";
    t.fn.editableutils = {inherit: function (t, e) {
        var i = function () {
        };
        ...
        for (var s = 0; s < i.length; s++)a = i[s], e.hasOwnProperty(a) && (o[a] = e[a]), n !== !0 && (r = a.toLowerCase(), e.hasOwnProperty(r) && (o[a] = e[r]));
        return o
        ...
        var r = t.isArray(e), o = [], s = this;
        return t.each(i, function (i, a) {
            if (a.children)o = o.concat(s.itemsByValue(e, a.children, n)); else if (r)t.grep(e,function (t) {
        ...
        var i, n, a, r = e.type;
        return"date" === r && ("inline" === e.mode ? t.fn.editabletypes.datefield ? r = "datefield" : t.fn.editabletypes.dateuifield && (r = "dateuifield") : t.fn.editabletypes.date ? r = "date" : t.fn.editabletypes.dateui && (r = "dateui"), "date" !== r || t.fn.editabletypes.date || (r = "combodate")), "datetime" === r && "inline" === e.mode && (r = "datetimefield"), "wysihtml5" !== r || t.fn.editabletypes[r] || (r = "textarea"), "function" == typeof t.fn.editabletypes[r] ? (i = t.fn.editabletypes[r], n = this.sliceObj(e, this.objectKeys(i.defaults)), a = new i(n)) : (t.error("Unknown type: " + r), !1)
    ...
    e.prototype = {containerName: null, containerDataName: null, innerCss: null, containerClass: "editable-container editable-popup", init: function (i, n) {
        this.$element = t(i), this.options = t.extend({}, t.fn.editableContainer.defaults, n), this.splitOptions(), this.formOptions.scope = this.$element[0], this.initContainer(), this.delayedHide = !1, this.$element.on("destroyed", t.proxy(function () {
            ...
            var n, a = t(i.target), r = [".editable-container", ".ui-datepicker-header", ".datepicker", ".modal-backdrop", ".bootstrap-wysihtml5-insert-image-modal", ".bootstrap-wysihtml5-insert-link-modal"];
            if (t.contains(document.documentElement, i.target) && !a.is(document)) {
                for (n = 0; n < r.length; n++)if (a.is(r[n]) || a.parents(r[n]).length)return;
        ...
        for (var i in this.options)i in e ? this.containerOptions[i] = this.options[i] : this.formOptions[i] = this.options[i]
    }, tip: function () {
        ...
        if (this.tip() && this.tip().is(":visible") && this.$element.hasClass("editable-open")) {
            if (this.$form.data("editableform").isSaving)return this.delayedHide = {reason: t}, void 0;
        ...
        t(".editable-open").each(function (i, n) {
            if (n !== e && !t(n).find(e).length) {
                var a = t(n), r = a.data("editableContainer");
                r && ("cancel" === r.options.onblur ? a.data("editableContainer").hide("onblur") : "submit" === r.options.onblur && a.data("editableContainer").tip().find("form").submit())
            }
        })
    }, activate: function () {
        ...
        var a = arguments;
        return this.each(function () {
            var r = t(this), o = "editableContainer", s = r.data(o), l = "object" == typeof n && n, h = "inline" === l.mode ? i : e;
            s || r.data(o, s = new h(this, l)), "string" == typeof n && s[n].apply(s, Array.prototype.slice.call(a, 1))
        })
    }, t.fn.editableContainer.Popup = e, t.fn.editableContainer.Inline = i, t.fn.editableContainer.defaults = {value: null, placement: "top", autohide: !0, onblur: "cancel", anim: !1, mode: "popup"}, jQuery.event.special.destroyed = {remove: function (t) {
        t.handler && t.handler()
    }}
}(window.jQuery), function (t) {
    "use strict";
    t.extend(t.fn.editableContainer.Inline.prototype, t.fn.editableContainer.Popup.prototype, {containerName: "editableform", innerCss: ".editable-inline", containerClass: "editable-container editable-inline", initContainer: function () {
    ...
    e.prototype = {constructor: e, init: function () {
        ...
        return e && "object" == typeof e ? (t.each(e, t.proxy(function (e, i) {
        ...
        var n = {}, a = arguments, r = "editable";
        switch (i) {
            case"validate":
                return this.each(function () {
                    var e, i = t(this), a = i.data(r);
                    a && (e = a.validate()) && (n[a.options.name] = e)
                }), n;
            case"getValue":
                return 2 === arguments.length && arguments[1] === !0 ? n = this.eq(0).data(r).value : this.each(function () {
                    var e = t(this), i = e.data(r);
                    i && void 0 !== i.value && null !== i.value && (n[i.options.name] = i.input.value2submit(i.value))
                }), n;
            case"submit":
                var o, s = arguments[1] || {}, l = this, h = this.editable("validate");
                return t.isEmptyObject(h) ? (o = this.editable("getValue"), s.data && t.extend(o, s.data), t.ajax(t.extend({url: s.url, data: o, type: "POST"}, s.ajaxOptions)).success(function (t) {
                    "function" == typeof s.success && s.success.call(l, t, s)
                }).error(function () {
                    "function" == typeof s.error && s.error.apply(l, arguments)
                })) : "function" == typeof s.error && s.error.call(l, h), this
        }
        return this.each(function () {
            var n = t(this), o = n.data(r), s = "object" == typeof i && i;
            return s && s.selector ? (o = new e(this, s), void 0) : (o || n.data(r, o = new e(this, s)), "string" == typeof i && o[i].apply(o, Array.prototype.slice.call(a, 1)), void 0)
        })
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {render: function () {
        var e = t.Deferred();
        ...
        var r = t.Deferred(), o = function () {
            "function" == typeof n ? n.call(i, e, this.sourceData, a) : this.value2htmlFinal(e, i), r.resolve()
        };
        ...
        var n;
        if (t.isFunction(this.options.source) ? (n = this.options.source.call(this.options.scope), this.sourceData = null) : n = this.options.source, this.options.sourceCache && t.isArray(this.sourceData))return e.call(this), void 0;
        try {
        ...
        if ("string" == typeof n) {
            if (this.options.sourceCache) {
                var r, o = n;
                if (t(document).data(o) || t(document).data(o, {}), r = t(document).data(o), r.loading === !1 && r.sourceData)return this.sourceData = r.sourceData, this.doPrepend(), e.call(this), void 0;
                if (r.loading === !0)return r.callbacks.push(t.proxy(function () {
                    this.sourceData = r.sourceData, this.doPrepend(), e.call(this)
                }, this)), r.err_callbacks.push(t.proxy(i, this)), void 0;
        ...
        if (t.isArray(e)) {
            ...
            for (var s = 0; s < e.length; s++)a = e[s], "object" == typeof a ? (i = 0, t.each(a, r), 1 === i ? o.push(n) : i > 1 && (a.children && (a.children = this.makeArray(a.children)), o.push(a))) : o.push({value: a, text: a})
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list), t.extend(e.prototype, {renderList: function () {
        this.$input.empty();
        var e = function (i, n) {
            var a;
            if (t.isArray(n))for (var r = 0; r < n.length; r++)a = {}, n[r].children ? (a.label = n[r].text, i.append(e(t("<optgroup>", a), n[r].children))) : (a.value = n[r].value, n[r].disabled && (a.disabled = !0), i.append(t("<option>", a).text(n[r].text)));
            return i
        };
        ...
        a.length && (n = a[0].text), t(i).text(n)
    }, autosubmit: function () {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.text), t.extend(e.prototype, {value2html: function (e, i) {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.text), t.extend(e.prototype, {render: function () {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.number), t.extend(e.prototype, {render: function () {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {render: function () {
        ...
        var n, a = "", r = this;
        this.options.select2.tags ? n = e : this.sourceData && (n = t.fn.editableutils.itemsByValue(e, this.sourceData, this.idFunc)), t.isArray(n) ? (a = [], t.each(n, function (t, e) {
            a.push(e && "object" == typeof e ? r.formatSelection(e) : e)
        })) : n && (a = r.formatSelection(n)), a = t.isArray(a) ? a.join(this.options.viewseparator) : a, t(i).text(a)
        ...
        if (this.$input.val(e).trigger("change", !0), this.isRemote && !this.isMultiple && !this.options.select2.initSelection) {
            ...
            if (!i && !n) {
                var a = {id: e, text: t(this.options.scope).text()};
        ...
        for (n = e.split(i), a = 0, r = n.length; r > a; a += 1)n[a] = t.trim(n[a]);
        return n
    }, autosubmit: function () {
    ...
    var e = function (e, i) {
        return this.$element = t(e), this.$element.is("input") ? (this.options = t.extend({}, t.fn.combodate.defaults, i, this.$element.data()), this.init(), void 0) : (t.error("Combodate should be applied to INPUT element"), void 0)
    };
    e.prototype = {constructor: e, init: function () {
        ...
        return t.each(this.map, function (t, i) {
            ...
            e = e.replace("{" + n + "}", '<select class="form-control ' + t + '"></select>')
        }), e
    }, initCombos: function () {
        var e = this;
        t.each(this.map, function (t) {
            var i, n, a = e.$widget.find("." + t);
            a.length && (e["$" + t] = a, i = "fill" + t.charAt(0).toUpperCase() + t.slice(1), n = e[i](), e["$" + t].html(e.renderItems(n)))
        })
        ...
        var t, e, i = this.initItems("M"), n = -1 !== this.options.template.indexOf("MMMM"), a = -1 !== this.options.template.indexOf("MMM"), r = -1 !== this.options.template.indexOf("MM");
        for (e = 0; 11 >= e; e++)t = n ? moment().date(1).month(e).format("MMMM") : a ? moment().date(1).month(e).format("MMM") : r ? this.leadZero(e + 1) : e + 1, i.push([e, t]);
        return i
    }, fillYear: function () {
        ...
        var t, e, i = this.initItems("h"), n = -1 !== this.options.template.indexOf("h"), a = (-1 !== this.options.template.indexOf("H"), -1 !== this.options.template.toLowerCase().indexOf("hh")), r = n ? 1 : 0, o = n ? 12 : 23;
        for (e = r; o >= e; e++)t = a ? this.leadZero(e) : e, i.push([e, t]);
        return i
    }, fillMinute: function () {
        ...
        var t = -1 !== this.options.template.indexOf("a"), e = (-1 !== this.options.template.indexOf("A"), [
            ["am", t ? "am" : "AM"],
            ["pm", t ? "pm" : "PM"]
        ]);
        return e
        ...
        return t.each(this.map, function (t) {
            if ("ampm" !== t) {
                var e = "day" === t ? 1 : 0;
                return n[t] = a["$" + t] ? parseInt(a["$" + t].val(), 10) : e, isNaN(n[t]) ? (r = !0, !1) : void 0
            }
        ...
        function i(e, i) {
            ...
            return e.children("option").each(function (e, a) {
                var r, o = t(a).attr("value");
                "" !== o && (r = Math.abs(o - i), ("undefined" == typeof n.distance || r < n.distance) && (n = {value: o, distance: r}))
            }), n.value
        }

        if (e) {
            var n = "string" == typeof e ? moment(e, this.options.format) : moment(e), a = this, r = {};
        ...
        return a.shift(), "getValue" === i && this.length && (n = this.eq(0).data("combodate")) ? n.getValue.apply(n, a) : this.each(function () {
            var n = t(this), r = n.data("combodate"), o = "object" == typeof i && i;
            r || n.data("combodate", r = new e(this, o)), "string" == typeof i && "function" == typeof r[i] && r[i].apply(r, a)
        })
    ...
    }}), e.defaults = t.extend({}, t.fn.editabletypes.abstractinput.defaults, {tpl: '<input type="text" class="form-control">', inputclass: null, format: "YYYY-MM-DD", viewformat: null, template: "D / MMM / YYYY", combodate: null}), t.fn.editabletypes.combodate = e
}(window.jQuery), function (t) {
    "use strict";
    t.extend(t.fn.editableform.Constructor.prototype, {initTemplate: function () {
        this.$form = t(t.fn.editableform.template), this.$form.find(".editable-error-block").addClass("help-block")
    }}), t.fn.editableform.buttons = '<button type="submit" class="btn blue editable-submit"><i class="icon-ok icon-white"></i></button><button type="button" class="btn default editable-cancel"><i class="icon-remove"></i></button>', t.fn.editableform.errorGroupClass = "has-error", t.fn.editableform.errorBlockClass = null
}(window.jQuery), function (t) {
    "use strict";
    t.fn.popover.defaults = t.fn.popover.Constructor.DEFAULTS, t.extend(t.fn.editableContainer.Popup.prototype, {containerName: "popover", containerDataName: "bs.popover", innerCss: t.fn.popover && t(t.fn.popover.defaults.template).find("p").length ? ".popover-content p" : ".popover-content", initContainer: function () {
        t.extend(this.containerOptions, {trigger: "manual", selector: !1, content: " ", template: t.fn.popover.defaults.template});
        var e;
        ...
        !function () {
            var e, i, n, a, r, o, s, l, h, c, d = this.tip();
            switch (r = "function" == typeof this.options.placement ? this.options.placement.call(this, d[0], this.$element[0]) : this.options.placement, e = /in/.test(r), d.removeClass("top right bottom left").css({top: 0, left: 0, display: "block"}), i = this.getPosition(e), n = d[0].offsetWidth, a = d[0].offsetHeight, r = e ? r.split(" ")[1] : r, l = {top: i.top + i.height, left: i.left + i.width / 2 - n / 2}, s = {top: i.top - a, left: i.left + i.width / 2 - n / 2}, h = {top: i.top + i.height / 2 - a / 2, left: i.left - n}, c = {top: i.top + i.height / 2 - a / 2, left: i.left + i.width}, r) {
                case"bottom":
                    l.top + a > t(window).scrollTop() + t(window).height() && (r = s.top > t(window).scrollTop() ? "top" : c.left + n < t(window).scrollLeft() + t(window).width() ? "right" : h.left > t(window).scrollLeft() ? "left" : "right");
                    break;
                case"top":
                    s.top < t(window).scrollTop() && (r = l.top + a < t(window).scrollTop() + t(window).height() ? "bottom" : c.left + n < t(window).scrollLeft() + t(window).width() ? "right" : h.left > t(window).scrollLeft() ? "left" : "right");
                    break;
                case"left":
                    h.left < t(window).scrollLeft() && (r = c.left + n < t(window).scrollLeft() + t(window).width() ? "right" : s.top > t(window).scrollTop() ? "top" : s.top > t(window).scrollTop() ? "bottom" : "right");
                    break;
                case"right":
                    c.left + n > t(window).scrollLeft() + t(window).width() && (h.left > t(window).scrollLeft() ? r = "left" : s.top > t(window).scrollTop() ? r = "top" : s.top > t(window).scrollTop() && (r = "bottom"))
            }
            switch (r) {
                case"bottom":
                    o = l;
            ...
            d.offset(o).addClass(r).addClass("in")
        }.call(this.container())
    }})
}(window.jQuery), function (t) {
    function e() {
    ...
    function i(e, i) {
        var n, a = t(e).data(), r = {}, o = new RegExp("^" + i.toLowerCase() + "([A-Z])"), i = new RegExp("^" + i.toLowerCase());
        for (var s in a)i.test(s) && (n = s.replace(o, function (t, e) {
    ...
    a.prototype = {constructor: a, _process_options: function (e) {
        ...
        var a = d.parseFormat(i.format);
        i.startDate !== -1 / 0 && (i.startDate = d.parseDate(i.startDate, a, i.language)), 1 / 0 !== i.endDate && (i.endDate = d.parseDate(i.endDate, a, i.language)), i.daysOfWeekDisabled = i.daysOfWeekDisabled || [], t.isArray(i.daysOfWeekDisabled) || (i.daysOfWeekDisabled = i.daysOfWeekDisabled.split(/[,\s]*/)), i.daysOfWeekDisabled = t.map(i.daysOfWeekDisabled, function (t) {
        ...
        this.isInput ? this._events = [
            ...
            [t(document), {mousedown: t.proxy(function (t) {
        ...
        this.element.trigger({type: e, date: a, format: t.proxy(function (t) {
        ...
        for (var t = "", e = 0; 12 > e;)t += '<span class="month">' + c[this.o.language].monthsShort[e++] + "</span>";
        ...
        var i = [], n = this.viewDate.getUTCFullYear(), a = this.viewDate.getUTCMonth(), r = this.date.valueOf(), o = new Date;
        ...
        var i, n = new Date(this.viewDate), a = n.getUTCFullYear(), r = n.getUTCMonth(), o = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, s = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, l = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCFullYear() : 1 / 0, h = 1 / 0 !== this.o.endDate ? this.o.endDate.getUTCMonth() : 1 / 0;
        this.date && this.date.valueOf(), this.picker.find(".datepicker-days thead th.datepicker-switch").text(c[this.o.language].months[r] + " " + a), this.picker.find("tfoot th.today").text(c[this.o.language].today).toggle(this.o.todayBtn !== !1), this.picker.find("tfoot th.clear").text(c[this.o.language].clear).toggle(this.o.clearBtn !== !1), this.updateNavArrows(), this.fillMonths();
        var u = e(a, r - 1, 28, 0, 0, 0, 0), p = d.getDaysInMonth(u.getUTCFullYear(), u.getUTCMonth());
        ...
        for (var g, m = []; u.valueOf() < f;) {
            if (u.getUTCDay() == this.o.weekStart && (m.push("<tr>"), this.o.calendarWeeks)) {
                var v = new Date(+u + 864e5 * ((this.o.weekStart - u.getUTCDay() - 7) % 7)), y = new Date(+v + 864e5 * ((11 - v.getUTCDay()) % 7)), b = new Date(+(b = e(y.getUTCFullYear(), 0, 1)) + 864e5 * ((11 - b.getUTCDay()) % 7)), x = (y - b) / 864e5 / 7 + 1;
                m.push('<td class="cw">' + x + "</td>")
            }
            g = this.getClassNames(u), g.push("day");
            var w = this.o.beforeShowDay(u);
            void 0 === w ? w = {} : "boolean" == typeof w ? w = {enabled: w} : "string" == typeof w && (w = {classes: w}), w.enabled === !1 && g.push("disabled"), w.classes && (g = g.concat(w.classes.split(/\s+/))), w.tooltip && (i = w.tooltip), g = t.unique(g), m.push('<td class="' + g.join(" ") + '"' + (i ? ' title="' + i + '"' : "") + ">" + u.getUTCDate() + "</td>"), u.getUTCDay() == this.o.weekEnd && m.push("</tr>"), u.setUTCDate(u.getUTCDate() + 1)
        }
        this.picker.find(".datepicker-days tbody").empty().append(m.join(""));
        var C = this.date && this.date.getUTCFullYear(), S = this.picker.find(".datepicker-months").find("th:eq(1)").text(a).end().find("span").removeClass("active");
        C && C == a && S.eq(this.date.getUTCMonth()).addClass("active"), (o > a || a > l) && S.addClass("disabled"), a == o && S.slice(0, s).addClass("disabled"), a == l && S.slice(h + 1).addClass("disabled"), m = "", a = 10 * parseInt(a / 10, 10);
        var _ = this.picker.find(".datepicker-years").find("th:eq(1)").text(a + "-" + (a + 9)).end().find("td");
        a -= 1;
        for (var k = -1; 11 > k; k++)m += '<span class="year' + (-1 == k ? " old" : 10 == k ? " new" : "") + (C == a ? " active" : "") + (o > a || a > l ? " disabled" : "") + '">' + a + "</span>", a += 1;
        _.html(m)
        ...
        if (1 == n.length)switch (n[0].nodeName.toLowerCase()) {
            case"th":
                switch (n[0].className) {
                    ...
                    case"prev":
                    case"next":
                        var a = d.modes[this.viewMode].navStep * ("prev" == n[0].className ? -1 : 1);
                        switch (this.viewMode) {
                            case 0:
                    ...
                    case"today":
                        var r = new Date;
                        r = e(r.getFullYear(), r.getMonth(), r.getDate(), 0, 0, 0), this.showMode(-2);
            ...
            case"span":
                if (!n.is(".disabled")) {
                    if (this.viewDate.setUTCDate(1), n.is(".month")) {
                        var l = 1, h = n.parent().find("span").index(n), c = this.viewDate.getUTCFullYear();
                        this.viewDate.setUTCMonth(h), this._trigger("changeMonth", this.viewDate), 1 === this.o.minViewMode && this._setDate(e(c, h, l, 0, 0, 0, 0))
                    } else {
                        var c = parseInt(n.text(), 10) || 0, l = 1, h = 0;
                        this.viewDate.setUTCFullYear(c), this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode && this._setDate(e(c, h, l, 0, 0, 0, 0))
                    }
            ...
            case"td":
                if (n.is(".day") && !n.is(".disabled")) {
                    var l = parseInt(n.text(), 10) || 1, c = this.viewDate.getUTCFullYear(), h = this.viewDate.getUTCMonth();
                    n.is(".old") ? 0 === h ? (h = 11, c -= 1) : h -= 1 : n.is(".new") && (11 == h ? (h = 0, c += 1) : h += 1), this._setDate(e(c, h, l, 0, 0, 0, 0))
                }
        }
        ...
        if (!e)return t;
        var i, n, a = new Date(t.valueOf()), r = a.getUTCDate(), o = a.getUTCMonth(), s = Math.abs(e);
        if (e = e > 0 ? 1 : -1, 1 == s)n = -1 == e ? function () {
            return a.getUTCMonth() == o
        } : function () {
            return a.getUTCMonth() != i
        }, i = o + e, a.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12); else {
            for (var l = 0; s > l; l++)a = this.moveMonth(a, e);
            i = a.getUTCMonth(), a.setUTCDate(r), n = function () {
                return i != a.getUTCMonth()
            }
        }
        for (; n();)a.setUTCDate(--r), a.setUTCMonth(i);
        return a
    ...
    r.prototype = {updateDates: function () {
        ...
        var i = t(e.target).data("datepicker"), n = i.getUTCDate(), a = t.inArray(e.target, this.inputs), r = this.inputs.length;
        if (-1 != a) {
            if (n < this.dates[a])for (; a >= 0 && n < this.dates[a];)this.pickers[a--].setUTCDate(n); else if (n > this.dates[a])for (; r > a && n > this.dates[a];)this.pickers[a++].setUTCDate(n);
            this.updateDates()
        }
    }, remove: function () {
    ...
    var o = t.fn.datepicker, s = t.fn.datepicker = function (e) {
        var o = Array.apply(null, arguments);
        o.shift();
        var s;
        return this.each(function () {
            var h = t(this), c = h.data("datepicker"), d = "object" == typeof e && e;
            if (!c) {
                var u = i(this, "date"), p = t.extend({}, l, u, d), f = n(p.language), g = t.extend({}, l, f, u, d);
                if (h.is(".input-daterange") || g.inputs) {
                    var m = {inputs: g.inputs || h.find("input").toArray()};
                    h.data("datepicker", c = new r(this, t.extend(g, m)))
                } else h.data("datepicker", c = new a(this, g))
            }
            return"string" == typeof e && "function" == typeof c[e] && (s = c[e].apply(c, o), void 0 !== s) ? !1 : void 0
        }), void 0 !== s ? s : this
    }, l = t.fn.datepicker.defaults = {autoclose: !1, beforeShowDay: t.noop, calendarWeeks: !1, clearBtn: !1, daysOfWeekDisabled: [], endDate: 1 / 0, forceParse: !0, format: "mm/dd/yyyy", keyboardNavigation: !0, language: "en", minViewMode: 0, rtl: !1, startDate: -1 / 0, startView: 0, todayBtn: !1, todayHighlight: !1, weekStart: 0}, h = t.fn.datepicker.locale_opts = ["format", "rtl", "weekStart"];
    t.fn.datepicker.Constructor = a;
    var c = t.fn.datepicker.dates = {en: {days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], daysShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"], months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthsShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], today: "Today", clear: "Clear"}}, d = {modes: [
        ...
        if ("string" == typeof n && (n = d.parseFormat(n)), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(i)) {
            var o, s, l = /([\-+]\d+)([dmwy])/, h = i.match(/([\-+]\d+)([dmwy])/g);
            i = new Date;
            for (var u = 0; u < h.length; u++)switch (o = l.exec(h[u]), s = parseInt(o[1]), o[2]) {
                case"d":
        ...
        var p, f, o, h = i && i.match(this.nonpunctuation) || [], i = new Date, g = {}, m = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], v = {yyyy: function (t, e) {
        ...
        var y = n.parts.slice();
        if (h.length != y.length && (y = t(y).filter(function (e, i) {
            return-1 !== t.inArray(i, m)
        }).toArray()), h.length == y.length) {
            for (var u = 0, b = y.length; b > u; u++) {
                if (p = parseInt(h[u], 10), o = y[u], isNaN(p))switch (o) {
                    case"MM":
                        f = t(c[r].months).filter(function () {
                            var t = this.slice(0, h[u].length), e = h[u].slice(0, t.length);
                            return t == e
                        }), p = t.inArray(f[0], c[r].months) + 1;
                        break;
                    case"M":
                        f = t(c[r].monthsShort).filter(function () {
                            var t = this.slice(0, h[u].length), e = h[u].slice(0, t.length);
                            return t == e
                        }), p = t.inArray(f[0], c[r].monthsShort) + 1
                }
                g[o] = p
            }
        ...
        var a = {d: e.getUTCDate(), D: c[n].daysShort[e.getUTCDay()], DD: c[n].days[e.getUTCDay()], m: e.getUTCMonth() + 1, M: c[n].monthsShort[e.getUTCMonth()], MM: c[n].months[e.getUTCMonth()], yy: e.getUTCFullYear().toString().substring(2), yyyy: e.getUTCFullYear()};
        a.dd = (a.d < 10 ? "0" : "") + a.d, a.mm = (a.m < 10 ? "0" : "") + a.m;
        for (var e = [], r = t.extend([], i.separators), o = 0, s = i.parts.length; s >= o; o++)r.length && e.push(r.shift()), e.push(a[i.parts[o]]);
        return e.join("")
    }, headTemplate: '<thead><tr><th class="prev"><i class="icon-angle-left"/></th><th colspan="5" class="datepicker-switch"></th><th class="next"><i class="icon-angle-right"/></th></tr></thead>', contTemplate: '<tbody><tr><td colspan="7"></td></tr></tbody>', footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'};
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.abstractinput), t.extend(e.prototype, {initPicker: function (e, i) {
    ...
    }}), e.defaults = t.extend({}, t.fn.editabletypes.abstractinput.defaults, {tpl: '<div class="editable-date well"></div>', inputclass: null, format: "yyyy-mm-dd", viewformat: null, datepicker: {weekStart: 0, startView: 0, minViewMode: 0, autoclose: !1}, clear: 'clear <i class="icon-remove" style="font-size:12px"></i>'}), t.fn.editabletypes.date = e
}(window.jQuery), function (t) {
    "use strict";
    var e = function (t) {
        this.init("datefield", t, e.defaults), this.initPicker(t, e.defaults)
    };
    t.fn.editableutils.inherit(e, t.fn.editabletypes.date), t.extend(e.prototype, {render: function () {
    ...
    }}), e.defaults = t.extend({}, t.fn.editabletypes.abstractinput.defaults, {tpl: '<div class="editable-date well"></div>', inputclass: null, format: "yyyy-mm-dd hh:ii", formatType: "standard", viewformat: null, datetimepicker: {todayHighlight: !1, autoclose: !1}, clear: 'clear <i class="icon-remove" style="font-size:12px"></i>'}), t.fn.editabletypes.datetime = e
}(window.jQuery), function (t) {
    "use strict";
    var e = function (t) {
        this.init("datetimefield", t, e.defaults), this.initPicker(t, e.defaults)
    };
    t.fn.editableutils.inherit(e, t.fn.editabletypes.datetime), t.extend(e.prototype, {render: function () {
    ...
    }}), e.defaults = t.extend({}, t.fn.editabletypes.datetime.defaults, {tpl: '<div class="input-group input-group-fixed date"><input type="text" readonly class="form-control input-medium pull-left"/><span class="input-group-btn pull-left"><button class="btn date-set default" type="button"><i class="icon-th"></i></button></span></div>', inputclass: "form-control input-medium", datetimepicker: {todayHighlight: !1, autoclose: !0}}), t.fn.editabletypes.datetimefield = e
}(window.jQuery), function (t) {
    "use strict";
    var e = function (i) {
    ...
    t.fn.editableutils.inherit(e, t.fn.editabletypes.list), t.extend(e.prototype, {renderList: function () {
        ...
        e.render = t.proxy(this.typeaheadRender, e), e.select = t.proxy(this.typeaheadSelect, e), e.move = t.proxy(this.typeaheadMove, e), this.renderClear(), this.setClass(), this.setAttr("placeholder")
    }, value2htmlFinal: function (e, i) {
        ...
        if (this.getIsObjects()) {
            var e = this.$input.data("value"), i = t.fn.editableutils.itemsByValue(e, this.sourceData);
            return i.length && i[0].text.toLowerCase() === this.$input.val().toLowerCase() ? e : null
        }
        return this.$input.val()
    }, getIsObjects: function () {
        if (void 0 === this.isObjects) {
            this.isObjects = !1;
            for (var t = 0; t < this.sourceData.length; t++)if (this.sourceData[t].value !== this.sourceData[t].text) {
                this.isObjects = !0;
                break
            }
        }
        return this.isObjects
    }, activate: t.fn.editabletypes.text.prototype.activate, renderClear: t.fn.editabletypes.text.prototype.renderClear, postrender: t.fn.editabletypes.text.prototype.postrender, toggleClear: t.fn.editabletypes.text.prototype.toggleClear, clear: function () {
        ...
        for (var e, i, n = [], a = [], r = []; e = t.shift();)i = e.text, i.toLowerCase().indexOf(this.query.toLowerCase()) ? ~i.indexOf(this.query) ? a.push(e) : r.push(e) : n.push(e);
        return n.concat(a, r)
        ...
        return(this.options.autoSelect || t) && this.$element.val(this.updater(t)).change(), this.hide()
