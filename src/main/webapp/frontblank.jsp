				...
				<ul id="revolutionul" style="display:none;">
					...
					<li data-transition="fade" data-slotamount="8"
						...
						<div class="caption lft slide_title slide_item_left" data-x="0"
							...
							data-easing="easeOutExpo">Hadoop集群火热搭建中</div>
					...
					<li data-transition="fade" data-slotamount="7"
						...
						</div> <!-- <div class="caption lfr slide_item_right" data-x="635"
					...
					<li data-transition="fade" data-slotamount="8"
						...
						<div class="caption lfr slide_desc" data-x="470" data-y="220"
							...
							实现我们内心中的理想乡，用游戏描绘我们的思想。<br/>世界都在我们的手中创造</div> <a
						class="caption lfr btn yellow slide_btn" href="" data-x="470"
		...
		<div class="container">
			...
			<div class="row quote-v1">
				<div class="col-md-9 quote-v1-inner">
					<span><i class="icon-light-on"></i>Write the Code Change the World</span>
				</div>
