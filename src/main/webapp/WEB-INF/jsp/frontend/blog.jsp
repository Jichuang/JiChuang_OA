        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 blog-posts margin-bottom-40"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8">
                        <h2>
                            <a href="frontpage/<%=blog.getBlogId()%>/blogitem.hopedo"><%=blog.getTitle()%>
                            </a>
                        </h2>
                        <ul class="blog-info">
                            <li><i class="icon-calendar"></i> <%=blog.getDate()%>
                            </li>
                            <li><i class="icon-comments"></i> <%=blog.getInfo()%>
                            </li>
                            <li><i class="icon-tags"></i><%=blog.getMemberId().getName() + ","
                                    + blog.getMemberId().getUsername()%>
                            </li>
                        </ul>
                        <%
