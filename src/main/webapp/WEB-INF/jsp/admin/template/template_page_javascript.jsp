...
<script src="admin_assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js" type="text/javascript"></script>
<script src="admin_assets/plugins/bootstrap-modal/js/bootstrap-modal.js" type="text/javascript"></script>
...
<script type="text/javascript" src="admin_assets/plugins/bootstrap-timepicker/js/bootstrap-timepicker.js"></script>
<script type="text/javascript" src="admin_assets/plugins/jquery-inputmask/jquery.inputmask.bundle.min.js"></script>
<script type="text/javascript" src="admin_assets/plugins/jquery.input-ip-address-control-1.0.min.js"></script>
<script src="admin_assets/plugins/jquery.pwstrength.bootstrap/src/pwstrength.js" type="text/javascript"></script>
<script src="admin_assets/plugins/bootstrap-switch/static/js/bootstrap-switch.min.js" type="text/javascript"></script>
<script src="admin_assets/plugins/jquery-tags-input/jquery.tagsinput.min.js" type="text/javascript"></script>
<script src="admin_assets/plugins/bootstrap-markdown/js/bootstrap-markdown.js" type="text/javascript"></script>
<script src="admin_assets/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js" type="text/javascript"></script>
...
<script src="admin_assets/js/cryptico/hash.js"></script>
<script src="admin_assets/js/cryptico/jsbn.js"></script>
<script src="admin_assets/js/cryptico/random.js"></script>
<script src="admin_assets/js/cryptico/rsa.js"></script>
