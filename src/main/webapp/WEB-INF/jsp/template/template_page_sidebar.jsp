...
<div class="page-sidebar navbar-collapse collapse">
	...
	<ul class="page-sidebar-menu">
		...
		<li><a href="javascript:;"> <i class="icon-cogs"></i> <span
			...
			<ul class="sub-menu">
				<li><a href="layout_horizontal_menu1.html"> 工作岗位管理</a></li>
				<li><a href="layout_horizontal_menu2.html"> 项目部门管理</a></li>
				<li><a href="layout_disabled_menu.html"> 员工信息管理</a></li>
				<li><a href="layout_sidebar_fixed.html"> 岗位权限管理</a></li>
				<li><a href="layout_promo.html"> 项目产品管理 </a></li>
				<li><a href="layout_email.html"> 季度战略管理</a></li>
				<li><a href="layout_sidebar_closed.html"> 系统综合设置</a></li>
				<li><a href="layout_boxed_not_responsive.html"> 个人偏好设置</a></li>
				<li><a href="layout_blank_page.html"> 关于本系统</a></li>
				<li><a href="layout_boxed_page.html"> 使用帮助FAQ</a></li>
			</ul></li>
		...
		<li class="active"><a href="javascript:;"> <i
			...
			<ul class="sub-menu">
				<li><a href="ui_general.html"> <span
						class="badge badge-roundless badge-warning">每日</span>个人每日考勤
				</a></li>
				<li><a href="ui_typography.html"> <span
						class="badge badge-roundless badge-warning">每日</span>每日工作计划
				</a></li>
				<li><a href="ui_buttons.html"> <span
						class="badge badge-roundless badge-success">季度</span>季度日程安排
				</a></li>
				<li><a href="ui_typography.html"> <span
						class="badge badge-roundless badge-important">项目</span>项目负责工作
				</a></li>
				<li><a href="ui_modals.html"> <span
						class="badge badge-roundless badge-warning">每日</span>每日工作报告
				</a></li>
				<li><a href="ui_extended_modals.html"> 团队成员通讯</a></li>
				<li><a href="ui_tabs_accordions_navs.html"> 提交代码审批</a></li>
				<li><a href="ui_tiles.html"> 查询审批状态</a></li>
				<li><a href="ui_toastr.html"><span
						class="badge badge-roundless badge-warning">重要</span>个人文档管理 </a></li>
				<li><a href="ui_tree.html"> 个人档案信息</a></li>
			</ul></li>
		...
		<li><a href="javascript:;"> <i class="icon-folder-open"></i>
			...
			<ul class="sub-menu">
				<li><a href="javascript:;"> <i class="icon-cogs"></i> Item
		...
		<li class=""><a href="javascript:;"> <i class="icon-sitemap"></i>
			...
			<ul class="sub-menu">
				...
				<li><a href="page_news.html"> <i class="icon-coffee"></i> <span
