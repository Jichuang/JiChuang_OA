...
public abstract class MybatisBaseGenericDAOImpl<T, ID extends Serializable>
		extends SqlSessionDaoSupport implements IBaseGenericDAO<T, ID> {
	...
	// paramMap.put("param", param);
	// return this.getSqlSession().selectList(sqlNamespace+"."+sqlName,
	// paramMap);
	// }
	// protected List<Object> getMap(String sqlName, Map param){
	// return this.getSqlSession().selectList(sqlNamespace+"."+sqlName, param);
	// }
	// protected List findPageBy(String sqlName, Object param,int pageNo, int
	// pageSize,String sort,String dir){
	// Map paramMap = new HashMap();
	// paramMap.put("param", param);
	// if (StringUtils.isEmpty(sort) || StringUtils.isEmpty(dir))
	// {
	...
	// RowBounds rowBound = new RowBounds(start,pageSize);
	// List lst = this.getSqlSession().selectList(sqlNamespace+"."+sqlName,
	// paramMap,rowBound);
	// return lst;
	// }
	//
	...
	// Map paramMap = new HashMap();
	// paramMap.put("param", param);
	// return (Integer)this.getSqlSession().selectOne(sqlNamespace+"."+sqlName,
	// paramMap);
	// }
